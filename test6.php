...
<html>
	...
	<body style="background-image:url('./img/test6background.png');background-repeat: no-repeat;background-size: 100% 157%;">
			<div style="height:15%;"></div>
		
			
				<form class="form-div" action="test6Answer.php" method="POST" >
					<br>
			  ...
			  <?php
				...
				<div class="col-md-4 text-center">
					<button type="submit" class="finalbtn"></button>
				</div>
